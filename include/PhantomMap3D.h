...
#pragma pack(pop)
	...
	public:
		...
		VOID			Intersects(TypeArray<CMapObject*>& rets, IntersectData* intersect);
		//多选一组模型
		VOID			SelectObjects(TypeArray<CMapObject*>& rets, const Rect& rc);
		//
		BOOL			GetHeight(IntersectData* intersect);		//取得当前点的高度
		//
	...
	public://runtime datas
		...
		BOOL							m_bShowObject;
		BOOL							m_bShowBlock;
		TypeArray<MapTextureFile>	m_textureFiles;
		TypeArray<MapObjectFile>	m_objectFiles;
		FileName						m_mapFile;
	...
	protected://save data
		...
		Size							m_mapSize;//场景大小
		int								m_tileSize;//格子大小
		TypeArray<MapTile>			m_tiles;
		TypeArray<unsigned char>	m_heights;
		TypeArray<CMapObject*>		m_objects;
		TypeArray<MapTrigger>		m_triggers;
		//
