...
namespace Phantom{
	...
	struct  PHANTOM_API OrientationEKF
	{
...
#define	MAX_MOVE_SPEED				2//保存最近三个数据
	...
	class  PHANTOM_API IntersectData
	{
	public:
	...
	class	 PHANTOM_API CamLineIntersect
	{
	protected:
		BOOL						m_bDirection;
	...
	class Camera;
	class  PHANTOM_API CamFrustumPlane
	{
	protected:
		friend	class	Camera;
		float3			p[4];
