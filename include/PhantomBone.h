...
#pragma pack(push, 1)
	...
	struct MaterialAnim
	{
		...
		float	fPlaybackRate;
		BOOL	bHasAnim;
		TypeArray<MaterialColorKey> keys;
	};
...
#pragma pack(pop)
	...
	class  PHANTOM_API BoneMatrixKey//: public BoneAnimationKey<matrix3x4>
	{
	public:
		BoneMatrixKey(){}
		...
		virtual	void					LoadData(CFileHelperR& r, int version)
		{
			...
			if(version<0x00000008){
				...
				{
					TypeArray<matrix3x4>	temp;
					temp.resize(numKey, 0);
...
#pragma pack(pop)
	class PHANTOM_API 	MeshActionRange: public Base
	{
	public:
	...
	class  PHANTOM_API MeshActionData: public MeshActionRange
	{
	public:
		MeshActionData();
		~MeshActionData();
	...
	protected:
		Mesh*							m_groupPtr;
		char							m_bHitKey;
		TypeArray<MeshBoneKeyR>			m_boneKeys;
		char							m_nPlayWave;
		char							m_bPlaySnd[2];
