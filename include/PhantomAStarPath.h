...
namespace Phantom{
	...
	class  PHANTOM_API AstarfindPath
	{
	public:
	...
	public:
		...
		bool					findway(TypeArray<float2>& rets, const float2& from, const float2& to, float fGridSizeW, float fGridSizeH);
		bool					m_bCalcNearest;
	protected:
